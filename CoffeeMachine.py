...
def buy():
    ...
    while True:
        ...
        if choice == '1':
            ...
            amount_dict['water'] = checker(water_amount, 350)   # 250 ml water = 1 cup
...
def fill():
    ...
    water_amount += int(input('Write how many ml of water do you want to add: '))
    milk_amount += int(input('Write how many ml of milk do you want to add: '))
    beans_amount += int(input('Write how many grams of coffee beans do you want to add: '))
